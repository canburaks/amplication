...
import { InstituteFindManyArgs } from "../../institute/base/InstituteFindManyArgs";
...
export class CountryResolverBase {
  ...
  @common.UseInterceptors(AclFilterResponseInterceptor)
  @graphql.ResolveField(() => [Institute])
  @nestAccessControl.UseRoles({
    resource: "Institute",
    action: "read",
    possession: "any",
  ...
  async institutes(
    ...
    const results = await this.service.findInstitutes(parent.id, args);
